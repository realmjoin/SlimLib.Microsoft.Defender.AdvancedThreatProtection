...
partial class SlimAtpClientImpl
{
    ...
    {
        var link = ODataLinkBuilder.BuildLink(options, $"software/{id}");
    ...
    {
        var nextLink = ODataLinkBuilder.BuildLink(options, "software");
    ...
    {
        var nextLink = ODataLinkBuilder.BuildLink(options, $"software/{id}/distributions");
    ...
    {
        var nextLink = ODataLinkBuilder.BuildLink(options, $"software/{id}/machineReferences");
    ...
    {
        var nextLink = ODataLinkBuilder.BuildLink(options, $"software/{id}/getmissingkbs");
    ...
    {
        var nextLink = ODataLinkBuilder.BuildLink(options, $"software/{id}/vulnerabilities");
