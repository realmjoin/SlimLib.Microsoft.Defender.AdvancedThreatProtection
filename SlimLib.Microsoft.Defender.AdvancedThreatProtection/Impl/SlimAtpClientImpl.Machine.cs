...
partial class SlimAtpClientImpl
{
    ...
    {
        var link = ODataLinkBuilder.BuildLink(options, $"machines/{id}");
    ...
    {
        var nextLink = ODataLinkBuilder.BuildLink(options, "machines");
    ...
    {
        var nextLink = ODataLinkBuilder.BuildLink(options, $"machines/{id}/logonusers");
    ...
    {
        var nextLink = ODataLinkBuilder.BuildLink(options, $"machines/{id}/software");
    ...
    {
        var nextLink = ODataLinkBuilder.BuildLink(options, $"machines/{id}/recommendations");
    ...
    {
        var nextLink = ODataLinkBuilder.BuildLink(options, $"machines/{id}/alerts");
    ...
    {
        var nextLink = ODataLinkBuilder.BuildLink(options, $"machines/{id}/vulnerabilities");
